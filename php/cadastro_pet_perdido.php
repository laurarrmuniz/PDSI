...
<body>
    ...
    <main>
        ...
        <form name="formCadastroPetPerdido" id="formCadastroPetPerdido" action="./insert_pet_perdido.php" method="POST" enctype="multipart/form-data">
...
<script src="../js/modal_imagem_perdido.js"></script>
...
<script src="../js/modal_form_perdido.js"></script>
