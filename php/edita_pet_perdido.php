...
if (isset($_GET['id'])) {
    // Armazenar o ID do pet perdido para edição
...
// Busca os dados do pet perdido
try {
    $stmt = $pdo->prepare("SELECT * FROM pet_perdido WHERE id = ?");
    $stmt->execute([$pet_id]);
    ...
    // Busca as fotos do pet perdido
    $stmtFotos = $pdo->prepare("SELECT * FROM foto_pets_perdido WHERE id_pet_perdido = ?");
...
<body>
    ...
    <main>
        ...
        <div class="container">
            <form name="formEditaPetperdido" id="editaPetPerdidoForm" enctype="multipart/form-data" action="atualiza_pet_perdido.php" method="post">
                ...
                <div class="container container-flex">
                    ...
                    <div class="item col-md-3">
                        <label for="local" class="form-label">Local onde foi perdido *</label>
                    ...
                    <div class="item col-md-3">
                        <label for="dia" class="form-label">Dia que foi perdido *</label>
                    ...
                    <div class="item col-md-3">
                        <label for="horario" class="form-label">Horário que foi perdido</label>
...
<script src="../js/modal_form_edita_perdido.js"></script>
